...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "cmd_value"))
        self.label_10.setText(_translate("MainWindow", "/cmd_vel"))
        self.label_12.setText(_translate("MainWindow", "/odom"))
        self.label_14.setText(_translate("MainWindow", "odom value"))
    ...
    def testshow(self):
        for i in range(0, 10):
            self.label_9.setText(QtCore.QCoreApplication.translate("MainWindow", str(i)))
